...
# Задаємо інтервал та кількість точок
...
# Визначаємо ступінь многочлена Тейлора
degree = 3

# Обчислюємо многочлен Тейлора за допомогою approximate_taylor_polynomial
taylor = approximate_taylor_polynomial(f, 0, degree, scale=1)

# Виводимо многочлен Тейлора
print('taylor =', taylor)

# Будуємо графік наближення многочленом Тейлора
